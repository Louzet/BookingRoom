...
final class Version20190115094744 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE inscription_ldap (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(64) NOT NULL, hostname VARCHAR(64) NOT NULL, port INT NOT NULL, basedn VARCHAR(64) NOT NULL, binddn VARCHAR(64) NOT NULL, password VARCHAR(64) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
