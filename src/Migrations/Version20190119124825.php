 ...
 */
final class Version20190119124825 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE inscription_ldap (id INT AUTO_INCREMENT NOT NULL, slug VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, hostname VARCHAR(255) NOT NULL, port INT NOT NULL, basedn VARCHAR(255) NOT NULL, binddn VARCHAR(255) NOT NULL, password VARCHAR(64) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, inscription_ldap_id INT NOT NULL, id_employ INT NOT NULL, password VARCHAR(64) NOT NULL, name VARCHAR(64) NOT NULL, firstname VARCHAR(64) NOT NULL, birthday DATETIME DEFAULT NULL, hiring_date DATETIME NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_8D93D6493DA3A00C (inscription_ldap_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6493DA3A00C FOREIGN KEY (inscription_ldap_id) REFERENCES inscription_ldap (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D6493DA3A00C');
