 ...
 */
final class Version20190119214829 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, image_id INT NOT NULL, name VARCHAR(128) NOT NULL, slug VARCHAR(255) NOT NULL, price_location DOUBLE PRECISION NOT NULL, place_capacity INT NOT NULL, ville VARCHAR(128) NOT NULL, address VARCHAR(255) NOT NULL, postal_code INT NOT NULL, disponible TINYINT(1) NOT NULL, date_creation DATETIME NOT NULL, INDEX IDX_729F519BC54C8C93 (type_id), UNIQUE INDEX UNIQ_729F519B3DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
